...
* the assessment of the outputs of the [RConsortium Object-Oriented Programming Working Group](https://github.com/RConsortium/OOP-WG) such as the S7 package as possible way to consolidate the object-oriented data model implemented in _geometa_.
