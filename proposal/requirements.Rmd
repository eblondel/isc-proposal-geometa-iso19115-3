...
The funding is established based on the time spent by Emmanuel Blondel (Consultant) to carry out the developements as detailed in the _Project plan / Technical delivery_ section. Cost is based on an average daily gross rate of 550 USD (500 EUR) and a total of 25 working days.

In-kind contributions are expected to be delivered in pilot use cases at national and international scale, covering various data domains (earth sciences, oceanography and marine sciences, fisheries, climate change), by collaborating with key contributors as listed the project _Signatories_.