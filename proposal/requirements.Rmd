...
* Provision of code documentation including standard R documentation and online user manual (wiki).
...
In-kind contributions are expected to be delivered in pilot use cases at national and international scale, covering various data domains (earth sciences, oceanography and marine sciences, fisheries, climate change), by collaborating with key contributors as listed in the project _Signatories_.